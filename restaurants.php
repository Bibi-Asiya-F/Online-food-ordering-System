                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>Food Elect - The Best Food Delivery App</h3>
                ...
                <div class="row top-footer">
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Kengeri</a> </li>
                            <li><a href="#">Malleshwaram</a> </li>
                            <li><a href="#">HSR Layout</a> </li>
                            <li><a href="#">Frazer Town</a> </li>
                            <li><a href="#">Marathall</a> </li>
                        </ul>
                    </div>
                </div>
                <!-- top footer ends -->
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address:</h5>
                            <p>Mahatma Gandhi Road, Bangalore - 560001.</p>
                            <h5>Call us at: <a href="tel:+918060006600">+91 80 60006600</a></h5></div>
